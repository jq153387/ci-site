...
<body class="bg-black">
    ...
    <div class="form-box" id="login-box">
        ...
        <div class="footer">
            <button type="submit" class="btn bg-olive btn-block"><?php echo lang('login_submit_btn');
                                                                    ?></button>

            <!-- <p><a href="<?php //echo site_url('forgot_password')
                                ?>"><?php //echo lang('login_forgot_password');
                                    ?></a></p>
                    
                    <a href="<?php //echo site_url('signup')
                                ?>" class="text-center"><?php //echo lang('create_user_submit_btn');
                                                        ?></a> -->
        </div>
        <?php echo form_close(); ?>
    </div>
