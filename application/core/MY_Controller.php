...
class MY_Controller extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->data['site_title'] = $this->config->item('ci_blog_sitename');
    ...
    protected function load_theme($content = null, $layout = true)
    {
        ...
        $this->data['nav_bot'] = $this->load->view('themes/' . $this->config->item('ci_blog_theme') . '/nav_bot', $this->data, TRUE);
    ...
    protected function current_groups()
    {
        ...
        if (!empty($this->current_user['ggroups'])) {
            $current_groups = explode(',', $this->current_user['ggroups']);
        }
